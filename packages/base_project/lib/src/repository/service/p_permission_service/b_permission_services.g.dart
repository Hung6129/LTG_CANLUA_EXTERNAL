...
part of 'b_permission_services.dart';
...
class _BPermissionService implements BPermissionService {
  _BPermissionService(
    this._dio, {
    this.baseUrl,
  }) {
    baseUrl ??= 'https://dvnn.loctroi.vn:2103/';
  }
  ...
  Future<List<PermissionLoctroiModel>> getPermission(username) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'User/GetUserPermissionList/${username}',
